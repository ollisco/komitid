...
def get_google_api_link():
    ...
    flow = Flow.from_client_secrets_file("resources/client_secret.json", scopes=scopes,
...
class Trip:
    ...
    def calc_travel_time(self):
        ...
        travel_time = stop - start  # In seconds
        travel_time = int(travel_time.total_seconds() / 60)
